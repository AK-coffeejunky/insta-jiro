...
Route::group(['middleware' => 'auth'], routes: function (): void {

    Route::get('/', [HomeController::class, 'index'])->name('index');
    Route::get('/people', [HomeController::class, 'search'])->name('search');

    Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], routes: function () {
    ...
    Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], routes: function () {
        ...
        Route::delete('/post/{id}/hidden', [PostsController::class, 'hidden'])->name('posts.hidden');
